 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getParameters <em>Parameters</em>}</li>
...
public class WorkDefinitionImpl extends MinimalEObjectImpl.Container implements WorkDefinition {
	...
	public EList<parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<parameter>(parameter.class, this, SimplepdlPackage.WORK_DEFINITION__PARAMETERS);
		}
		return parameters;
	}
	...
	public EList<Guidance> getGuidance() {
		if (guidance == null) {
			guidance = new EObjectResolvingEList<Guidance>(Guidance.class, this, SimplepdlPackage.WORK_DEFINITION__GUIDANCE);
		}
		return guidance;
	}
