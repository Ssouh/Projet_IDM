	...
	protected void addOutgoingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Noeud_outgoing_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Noeud_outgoing_feature", "_UI_Noeud_type"),
				 PetrinetPackage.Literals.NOEUD__OUTGOING,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIngoingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Noeud_ingoing_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Noeud_ingoing_feature", "_UI_Noeud_type"),
				 PetrinetPackage.Literals.NOEUD__INGOING,
				 true,
				 false,
				 true,
				 null,
