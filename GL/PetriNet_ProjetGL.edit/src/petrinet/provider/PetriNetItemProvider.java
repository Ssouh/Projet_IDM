...
public class PetriNetItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PetrinetPackage.Literals.PETRI_NET__NOEUD);
			childrenFeatures.add(PetrinetPackage.Literals.PETRI_NET__ARC);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PetrinetPackage.Literals.PETRI_NET__NOEUD,
				 PetrinetFactory.eINSTANCE.createNoeud()));
		...
		newChildDescriptors.add
			(createChildParameter
				(PetrinetPackage.Literals.PETRI_NET__ARC,
