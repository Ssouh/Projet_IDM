...
public class ResourceItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOccuranceNbPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Occurance Nb feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOccuranceNbPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resource_OccuranceNb_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resource_OccuranceNb_feature", "_UI_Resource_type"),
				 SimplepdlPackage.Literals.RESOURCE__OCCURANCE_NB,
				 true,
				 false,
				 false,
