...
public class ProcessItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimplepdlPackage.Literals.PROCESS__WORK_DEFINITIONS);
			childrenFeatures.add(SimplepdlPackage.Literals.PROCESS__WORK_SEQUENCES);
			childrenFeatures.add(SimplepdlPackage.Literals.PROCESS__GUIDANCE);
			childrenFeatures.add(SimplepdlPackage.Literals.PROCESS__RESOURCE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimplepdlPackage.Literals.PROCESS__WORK_DEFINITIONS,
				 SimplepdlFactory.eINSTANCE.createWorkDefinition()));

		newChildDescriptors.add
			(createChildParameter
				(SimplepdlPackage.Literals.PROCESS__WORK_SEQUENCES,
				 SimplepdlFactory.eINSTANCE.createWorkSequence()));

		newChildDescriptors.add
			(createChildParameter
				(SimplepdlPackage.Literals.PROCESS__GUIDANCE,
				 SimplepdlFactory.eINSTANCE.createGuidance()));

		newChildDescriptors.add
			(createChildParameter
				(SimplepdlPackage.Literals.PROCESS__RESOURCE,
