...
public class PetrinetItemProviderAdapterFactory extends PetrinetAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link petrinet.Noeud} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected NoeudItemProvider noeudItemProvider;

	/**
	 * This creates an adapter for a {@link petrinet.Noeud}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createNoeudAdapter() {
		if (noeudItemProvider == null) {
			noeudItemProvider = new NoeudItemProvider(this);
		}

		return noeudItemProvider;
	}
	...
	public void dispose() {
		...
		if (noeudItemProvider != null) noeudItemProvider.dispose();
