 ...
 * </p>
 * <ul>
 *   <li>{@link project.simple.pDL.impl.ResourceImpl#getName <em>Name</em>}</li>
 *   <li>{@link project.simple.pDL.impl.ResourceImpl#getOccuranceNb <em>Occurance Nb</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceImpl extends MinimalEObjectImpl.Container implements Resource
{
  ...
  {
    return PDLPackage.Literals.RESOURCE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDLPackage.RESOURCE__NAME, oldName, name));
  }
  ...
  public void setOccuranceNb(int newOccuranceNb)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDLPackage.RESOURCE__OCCURANCE_NB, oldOccuranceNb, occuranceNb));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PDLPackage.RESOURCE__NAME:
        return getName();
      case PDLPackage.RESOURCE__OCCURANCE_NB:
