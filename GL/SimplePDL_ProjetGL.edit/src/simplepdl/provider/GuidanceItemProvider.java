...
public class GuidanceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Guidance_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Guidance_description_feature", "_UI_Guidance_type"),
				 SimplepdlPackage.Literals.GUIDANCE__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Guidance)object).getDescription();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Guidance.class)) {
			case SimplepdlPackage.GUIDANCE__DESCRIPTION:
