...
public class ArcImpl extends MinimalEObjectImpl.Container implements Arc {
	...
	public void setSource(Noeud newSource) {
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject)source).eInverseRemove(this, PetrinetPackage.NOEUD__OUTGOING, Noeud.class, msgs);
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, PetrinetPackage.NOEUD__OUTGOING, Noeud.class, msgs);
	...
	public void setTarget(Noeud newTarget) {
		if (newTarget != target) {
			NotificationChain msgs = null;
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, PetrinetPackage.NOEUD__INGOING, Noeud.class, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, PetrinetPackage.NOEUD__INGOING, Noeud.class, msgs);
