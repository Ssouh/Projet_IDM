...
import project.simple.generator.PDLGenerator;
import project.simple.parser.antlr.PDLAntlrTokenFileProvider;
import project.simple.parser.antlr.PDLParser;
import project.simple.parser.antlr.internal.InternalPDLLexer;
import project.simple.scoping.PDLScopeProvider;
import project.simple.serializer.PDLSemanticSequencer;
import project.simple.serializer.PDLSyntacticSequencer;
import project.simple.services.PDLGrammarAccess;
import project.simple.validation.PDLConfigurableIssueCodesProvider;
import project.simple.validation.PDLValidator;
...
public abstract class AbstractPDLRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "project/simple/PDL.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("project.simple.PDL");
	}
